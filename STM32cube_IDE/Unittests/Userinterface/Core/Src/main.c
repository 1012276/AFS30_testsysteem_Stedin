...
#define BLAUWE_LED_PORT GPIOG

#define GROENE_LED_PIN GPIO_PIN_3
#define GROENE_LED_PORT GPIOG

#define RODE_LED_PIN GPIO_PIN_2
#define RODE_LED_PORT GPIOG

#define START_KNOP_PIN GPIO_PIN_12
#define START_KNOP_PORT GPIOB

#define PAUZEER_KNOP_PIN GPIO_PIN_13
#define PAUZEER_KNOP_PORT GPIOB

#define STOP_KNOP_PIN GPIO_PIN_14
#define STOP_KNOP_PORT GPIOB
/* USER CODE END PD */
...
// Functie om de status van het testsysteem bij te werken
...
// Functie voor het controleren van de knoppen
void check_knoppen() {
...
/* Configure the peripherals common clocks */
  ...
  while (1)
  {
    /* USER CODE END WHILE */
       check_knoppen();
       HAL_Delay(100);
       // Voer de knippering uit als het systeem gepauzeerd is
