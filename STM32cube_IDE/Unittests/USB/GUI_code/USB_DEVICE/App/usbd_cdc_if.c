...
//{
//    // Voeg de nieuwe ontvangen data toe aan je buffer
//    if (receivedLength + *Len < BUFFER_SIZE_)
//    {
//        // Voeg de fragmenten toe aan de bestaande ontvangen data
//        strncat(receivedData, (char*)Buf, *Len);
//        receivedLength += *Len;
//
//        // Controleer op het einde van het bericht (bijvoorbeeld '\n')
//        if (strchr((char*)receivedData, '\n') != NULL)
//        {
//            // Verwerk het volledige bericht zodra we een newline hebben ontvangen
//            CheckReceivedData();
//        }
//    }
//    else
//    {
//        // Buffer overflow, reset de buffer of geef een foutmelding
